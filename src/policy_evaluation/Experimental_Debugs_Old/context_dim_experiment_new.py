...
context_dim_list = [5, 10, 15, 20, 25, 30]

os.makedirs("context_dim_report/results", exist_ok=True)
...
def compare_estimators(null_policy, target_policy, environment, item_vectors, config, seed):
...
if __name__ == "__main__":
    ...
    for context_dim in tqdm(context_dim_list):
