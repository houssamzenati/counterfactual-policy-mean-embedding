...
alpha_multiplier_list = [-0.3, 0.3, 0.5]
...
# Save results
full_results.to_csv("Results_UnknownProps/OPE_domain_shift_result_minus03_upto_05_Unknown_Propensities.csv", index=False)